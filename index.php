...
<head>
    ...
    <title>OnlineStudy4u | one stop solution for all your placement needs</title>
</head>
<body>
<style>
...
<!-- companies -->
    <!-- <section>
      <div class="container Top-companies">
        <div class="companies1">
          <h4>Get hired by top-companies :</h4>
           <hr>
          <ul class="companies">
            <li class="brand-logo">
              <img src="images/tcs-color.png" alt="">
            </li>
            <li class="brand-logo">
              <img src="images/pngfind.com-wipro-logo-png-6829362.png" alt="">
            </li>
            <li class="brand-logo"><img src="images/Accenture-Logo.wine.png" alt=""></li>
            <li class="brand-logo"><img src="images/IBM-Logo.wine.png" alt=""></li>
            <li class="brand-logo"><img src="images/Capgemini-Logo.wine.png" alt=""></li>
          </ul>
        </div>
      </div>
    </section> -->
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Find our best videos for free<p>
    </div>
    <div class="flex flex-wrap">
      <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
        ...
        <a class="text-indigo-500 inline-flex items-center">Watch video
      ...
      <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
        <h2 class="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">miscellaneous</h2>
        <p class="leading-relaxed text-base mb-4">Fingerstache flexitarian street art 8-bit waistcoat. Distillery hexagon disrupt edison bulbche.</p>
        <a class="text-indigo-500 inline-flex items-center">Watch video
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Why choose us?</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">We at onlinestudy4u have the best faculty. The course here are easy, practical and informative. We provide live classes which help you to get your dream job. Find the statics of our. </p>
    </div>
    <div class="flex flex-wrap -m-4 text-center">
      ...
      <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <h2 class="title-font font-medium text-3xl text-gray-900">256K+</h2>
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt adipisci, molestiae vero deserunt veritatis laboriosam doloribus fugit porro deleniti sunt et veniam dolorem magni, possimus perspiciatis enim nostrum, itaque quod!</p>
    </div>
